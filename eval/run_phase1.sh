...
echo "=== Coding-Agent Phase 1: $(date) ==="
...
run_model 5 "principled-intelligence/Qwen3.5-4B-text-only" &
PIDS+=($!); LABELS+=("GPU5 Qwen3.5-4B-text")
run_model 6 "Qwen/Qwen3.5-27B" &
PIDS+=($!); LABELS+=("GPU6 Qwen3.5-27B")
run_model 7 "Qwen/Qwen3.5-35B-A3B" &
PIDS+=($!); LABELS+=("GPU7 Qwen3.5-35B-A3B")
